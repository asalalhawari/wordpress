...
$fashion_estore_single_post_cat = get_theme_mod( 'fashion_estore_single_post_cat', 1 );
$fashion_estore_single_post_page_content =  get_theme_mod( 'fashion_estore_single_post_page_content', 1 );
?>
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="entry-content">
        <?php if ($fashion_estore_single_post_page_content == 1 ) {?>
            <?php
            the_content(sprintf(
                wp_kses(
    ...
    <?php if( $fashion_estore_single_post_cat == 1 ) {?>
