<?php
    ...
    if($fashion_estore_scroll_to_top_border_radius != false){
        $fashion_estore_theme_css .='#colophon a#button{';
            $fashion_estore_theme_css .='border-radius: '.esc_attr($fashion_estore_scroll_to_top_border_radius).'px;';
        $fashion_estore_theme_css .='}';
    }
    ...
    $fashion_estore_copyright_content_alignment = get_theme_mod( 'fashion_estore_copyright_content_alignment','Right');
