        ...
        <?php if (get_theme_mod('ecommerce_landing_page_footer_hide_show', true)){ ?>
            <aside id="footer" class="copyright-wrapper" role="complementary" aria-label="<?php esc_attr_e( 'Footer', 'ecommerce-landing-page' ); ?>">
                <div class="container">
                    ...
                    ?>
                     <div class="row">
                        <div class="<?php echo !is_active_sidebar('footer-1') ? 'footer_hide' : esc_attr($ecommerce_landing_page_colmd); ?> col-lg-3 col-md-3 col-xs-12 footer-block">
                        ...
                        <div class="<?php echo !is_active_sidebar('footer-2') ? 'footer_hide' : esc_attr($ecommerce_landing_page_colmd); ?> col-lg-3 col-md-3 col-xs-12 footer-block pe-2">
                        ...
                        <div class="<?php echo !is_active_sidebar('footer-3') ? 'footer_hide' : esc_attr($ecommerce_landing_page_colmd); ?> col-lg-3 col-md-3 col-xs-12 footer-block">
                        ...
                        <div class="<?php echo !is_active_sidebar('footer-4') ? 'footer_hide' : esc_attr($ecommerce_landing_page_colmd); ?> col-lg-3 col-md-3 col-xs-12 footer-block">
