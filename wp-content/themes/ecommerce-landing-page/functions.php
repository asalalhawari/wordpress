...
function ecommerce_landing_page_activation_notice() {
	...
	echo '<p>'. esc_html__( 'Thank you for choosing Ecommerce Landing Page. Would like to have you on our Welcome page so that you can reap all the benefits of our Ecommerce Landing Page.', 'ecommerce-landing-page' ) .'</p>';
	echo '<span><a href="'. esc_url( admin_url( 'themes.php?page=ecommerce_landing_page_guide' ) ) .'" class="button button-primary">'. esc_html__( 'DEMO IMPORT', 'ecommerce-landing-page' ) .'</a></span>';
	...
	echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/landing-page-wordpress-theme' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'ecommerce-landing-page' ) .'</a></span>';
	echo '<span class="bundle-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/wp-theme-bundle' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'THEME BUNDLE', 'ecommerce-landing-page' ) .'</a></span>';
	echo '</div>';
}
...
define('ECOMMERCE_LANDING_PAGE_PRO_DOC',__('https://preview.vwthemesdemo.com/docs/ecommerce-landing-page-pro/','ecommerce-landing-page'));
