...
$read_more        = get_theme_mod( 'slider_readmore', __( 'SHOP NEW ARRIVALS', 'blossom-ecommerce' ) );
$banner_title     = get_theme_mod( 'banner_title', __( 'Find Your Best Holiday', 'blossom-ecommerce' ) );
$banner_subtitle  = get_theme_mod( 'banner_subtitle', __( 'Find great adventure holidays and activities around the planet.', 'blossom-ecommerce' ) );
$banner_label     = get_theme_mod( 'banner_label', __( 'Purchase', 'blossom-ecommerce' ) );
$banner_link      = get_theme_mod( 'banner_link', '#' );
$caption_align    = get_theme_mod( 'banner_caption_align', 'left-align' );
...
if( ( $ed_banner == 'static_banner' ) && has_custom_header() ){ 
    ...
    <div id="banner_section" class="site-banner<?php echo esc_attr( $custom_header_class ); ?> <?php echo esc_attr( $caption_align ); ?>">
        <?php 
